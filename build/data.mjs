...
export const CONDITIONS = {
  ...
  'high-creatinine-without-dialysis': {
    ...
    symptoms: ['Tiredness and low energy', 'Swelling in feet or face', 'Foamy or reduced urine', 'Loss of appetite, nausea', 'Itching or dry skin', 'High blood pressure'],
    approach: ['Root-cause identification behind the raised creatinine, so reversible causes are treated first', 'A personalized Indian kidney diet (RiiMS Renal Plate) and avoidance of the common nephrotoxins', 'Blood pressure and sugar control coordinated with your treating doctor, supporting it, never replacing it', 'Regular monitoring on a Kidney Alert System so any change is caught early'],
  ...
  'laser-kidney-stone-treatment': {
    ...
    about: 'Laser stone treatment, including RIRS (retrograde intrarenal surgery) and laser lithotripsy, uses a laser passed through a thin scope to break a stone into tiny fragments that can pass out, usually for stones that are larger, stuck, or causing a blockage or infection. Not every stone needs a procedure, and many pass with hydration and time. RIIMS gives report-based guidance on whether a procedure is genuinely needed, helps you understand the options, and coordinates referral to a urologist for laser/RIRS when it is advised. Afterwards it supports you with hydration, diet and prevention so stones are less likely to return.',
...
export const HEART = {
  ...
  'triglycerides': {
    ...
    approach: [
      ...
      'Reading triglycerides alongside HDL and your overall risk, because Indians tend to show high triglycerides with low HDL',
...
const DEFAULT_WHY = [
  { icon: 'target', title: 'Kidney-led, integrated institute', desc: 'A team built around nephrology and kidney health, and the same doctor-led approach for liver, heart and metabolic care.' },
