...
export function searchBanner(base = '') {
  ...
  const slides = BANNERS.map((b, i) => {
    const media = i === 0
      ? `<picture><source srcset="${base}assets/banner-1.webp" type="image/webp"><img src="${base}assets/banner-1.jpg" width="1920" height="500" fetchpriority="high" alt="${esc(b.alt)}" style="display:block;width:100%;height:100%;object-fit:cover"></picture>`
      : `<img src="${base}assets/${b.img}.webp" width="1920" height="500" loading="lazy" decoding="async" alt="${esc(b.alt)}" style="display:block;width:100%;height:100%;object-fit:cover">`;
