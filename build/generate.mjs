...
function clinicGraph() {
  return {
    ...
    description: 'Kidney-led integrated medical institute offering ethical, doctor-led care for high creatinine, CKD, kidney failure and dialysis guidance, plus in-house liver, heart and metabolic disease care, alongside Ayurveda-supported lifestyle care.',
    url: `${SITE.origin}/`,
...
function head(p) {
  ...
  // Social share image: the first hero banner (1600x800 JPEG, ~175KB).
  const ogImg = `${SITE.origin}/assets/banner-1.jpg`;
  return `<!doctype html>
<html lang="en-IN">
<head>
  <meta charset="utf-8" />
...
const pages = [
  {
    ...
    title: 'Kidney Specialist in Delhi-NCR | High Creatinine, CKD & Dialysis',
    desc: 'Ethical, doctor-led kidney care across Delhi-NCR (based in Baraut, UP) — high creatinine, CKD, dialysis guidance, kidney diet & report review, with integrated Ayurveda support.',
